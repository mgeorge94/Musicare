...
//! panels
const containerPannels = document.querySelector('.container-panel');
...
panels.forEach((panel) => {
 ...
 containerPannels.addEventListener('mouseleave', () => {
  removeActiveClasses();
 });
});
...
// 	pageScroll();
// });
//! slides pentru Instrumente reparate
...
const fixedInstrumentsSlides = [
 ...
 },
 {
  ...
  tech: 'Mihai Bendeac',
  techPic:
   'https://lh3.googleusercontent.com/proxy/7Gf6Ewbfjmh-Jc4RGEjHo3fuKxS1WsIiByW3M_D3u3KH3KfYFsGnVttAi7WoIkJoACiOjMvWXgvAdwdFQm2FmZdCThTC',
  about: `'Doloribus, quaerat. Accusantium provident architecto earum
        aliquid harum quis molestias iusto quaerat qui ex iure
        similique ipsa amet facilis consequuntur neque sunt nihil
        officia temporibus! Dicta quam, accusamus obcaecati quas culpa
  ...
  fixingPic3:
   'https://www.ntdaily.com/wp-uploads/2018/04/IMG_4902.jpg',
 },
 {
  type: 'Trompetă',
  tech: 'Dana Budeanu',
...
// 					let leftSlideHTML = `<div data-instrumentType = "${type}"class="content-slide">  <img  class="tec-pannel" src="${techPic}";/>
//                     <h3> Tehnician : ${tech}</h3>
//                     <p> cacat ${about}</p>
//                     <img class="slide-img" src="${pic1}"	/>
//                     <h4>Experiență profesională: </h4>
//                     <p>alt cacat${experience}</p>
//                     <img class="slide-img" src="${pic2}"	/>
//                     <img class="slide-img" src="${pic3}"	/>
//                     </div>`;
...
const toBuyInstrumentsSlides = [
 ...
 },
 {
  ...
  description: `blanditiis ut obcaecati quos, repellendus illum expedita
		...
		exercitationem earum iste ab eaque commodi perspiciatis,
		amet fuga velit deleniti.`,
  picture: 'http://clipart-library.com/images/kcKoxjr6i.jpg',
  advantages1: `blanditiis ut obcaecatd`,
  advantages2: `unde aliquam mollitia illum, tenetur ea velit eum maiores
		eius! `,
  advantages3: `Soluta cumque amet aliquam aut alias voluptatum
 ...
 },
 {
  ...
  description: `blanditiis ut obcaecati quos, repellendus illum expedita
		...
		amet fuga velit deleniti.`,
  picture:
   'https://images.pexels.com/photos/306175/pexels-photo-306175.jpeg?cs=srgb&dl=pexels-lukas-306175.jpg&fm=jpg',
  advantages1: `blanditiis ut obcaecatd`,
  advantages2: `unde aliquam mollitia illum, tenetur ea velit eum maiores
		eius! `,
  advantages3: `Soluta cumque amet aliquam aut alias voluptatum
  ...
  panels.forEach(function (panel) {
   panel.addEventListener('click', () => {
    ...
    matchedToBuySlides.forEach(function () {
     ...
     let rightSlideHTML = `
					<div data-instrumentType = "${type}" class="content-slide"> 
						<h4> Descriere</h4>
						<p>${description}</p>
     ...
     seeInstrument.addEventListener('click', () => {
      instruments.forEach((element) => {
       if (element.dataset.name === slide.type) {
        element.removeAttribute('hidden');
        console.log('show fuking instruments');
       } else {
