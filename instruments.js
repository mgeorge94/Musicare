...
const instrArr = [];
let doubleHandleSlider = document.querySelector(
...
const allInstruments = [
 ...
 },
 {
  ...
  picture:
   'https://sc04.alicdn.com/kf/HTB1F4NxHVXXXXbwXXXXq6xXFXXXk.jpg',
 },
 {
 ...
 },
 {
  ...
  picture:
   'https://i.ebayimg.com/images/g/yVwAAOSwww1ceJOT/s-l640.jpg',
 },
 {
  name: 'yamaha881',
  type: 'Flaut',
...
function getInstruments() {
 allInstruments.forEach(function (instrument) {
  ...
  instrumentsContainer.insertAdjacentHTML(
   'afterbegin',
   instrumentsHTML
  );
...
const sliderFunction = function () {
 ...
 doubleHandleSlider.noUiSlider.on(
  'change',
